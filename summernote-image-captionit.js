      ...
      context.memo('button.captionIt',function(){
        var button=ui.button({
          ...
          click:function(){
            ...
            if($parentAnchorLink.is('figure')){
              $($parentAnchorLink).find('figcaption').remove();
              $(img).unwrap('figure');
            }else{
